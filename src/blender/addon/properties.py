...
enum_devices = (
    ('CPU', "CPU", "Use CPU for ray tracing"),
    ('GPU', "GPU Compute", "Use RadeinRays ray tracing, configured in the system tab in the user preferences"),
)
...
enum_integrator = (
    ('SIMPLE', "Biased ray tracing", "Biased ray trading"),
...
enum_device_type = (
    ('ANY', "ANY", "ANY", 0),
    ('EMBREE', "Embree", "Embree", 1),
    ('VULKAN', "Vulkan", "Vulkan", 2),
    ('OPENCL', "OpenCL", "OpenCL", 3)
)
...
class SteamRenderSettings(bpy.types.PropertyGroup):

    device: EnumProperty(
        name="Device",
        description="Device to use for ray tracing",
        items=enum_devices,
        default='CPU',
    )
    ...
    def _devices_update_callback(self, context):
        ...
        return _steam.debug_flags_update(scene)
    ...
    @classmethod
    def register(cls):
        bpy.types.Scene.steam = PointerProperty(
            name="Steam Render Settings",
            description="Steam render settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Scene.steam


class SteamCameraSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Camera.steam = PointerProperty(
            name="Steam Camera Settings",
            description="Steam camera settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Camera.steam


class SteamMaterialSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Material.steam = PointerProperty(
            name="Steam Material Settings",
            description="Steam material settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Material.steam


class SteamLightSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Light.steam = PointerProperty(
            name="Steam Light Settings",
            description="Steam light settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Light.steam


class SteamWorldSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.World.steam = PointerProperty(
            name="Steam World Settings",
            description="Steam world settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.World.steam


class SteamVisibilitySettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Object.steam_visibility = PointerProperty(
            name="Steam Visibility Settings",
            description="Steam visibility settings",
            type=cls,
        )

        bpy.types.World.steam_visibility = PointerProperty(
            name="Steam Visibility Settings",
            description="Steam visibility settings",
            type=cls,
        )
    ...
    @classmethod
    def unregister(cls):
        del bpy.types.Object.steam_visibility
        del bpy.types.World.steam_visibility


class SteamMeshSettings(bpy.types.PropertyGroup):
    @classmethod
    def register(cls):
        bpy.types.Mesh.steam = PointerProperty(
            name="Steam Mesh Settings",
            description="Steam mesh settings",
            type=cls,
        )
        bpy.types.Curve.steam = PointerProperty(
            name="Steam Mesh Settings",
            description="Steam mesh settings",
            type=cls,
        )
        bpy.types.MetaBall.steam = PointerProperty(
            name="Steam Mesh Settings",
            description="Steam mesh settings",
            type=cls,
        )
    ...
    @classmethod
    def unregister(cls):
        del bpy.types.Mesh.steam
        del bpy.types.Curve.steam
        del bpy.types.MetaBall.steam


class SteamObjectSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Object.steam = PointerProperty(
            name="Steam Object Settings",
            description="Steam object settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Object.steam


class SteamCurveRenderSettings(bpy.types.PropertyGroup):
    ...
    use_curves: BoolProperty(
        name="Use Steam Hair Rendering",
        description="Activate Steam hair rendering for particle system",
        default=True,
    )
    ...
    @classmethod
    def register(cls):
        bpy.types.Scene.steam_curves = PointerProperty(
            name="Steam Hair Rendering Settings",
            description="Steam hair rendering settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Scene.steam_curves
...
class SteamAOVPass(bpy.types.PropertyGroup):
    name: StringProperty(
        name="Name",
...
class SteamRenderLayerSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.ViewLayer.steam = PointerProperty(
            name="Steam ViewLayer Settings",
            description="Steam ViewLayer Settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.ViewLayer.steam


class SteamDeviceSettings(bpy.types.PropertyGroup):
    id: StringProperty(name="ID")
    name: StringProperty(name="Name")
    use: BoolProperty(name="Use", default=True)
    type: EnumProperty(name="Type", items=enum_device_type, default='ANY')


class SteamPreferences(bpy.types.AddonPreferences):
    bl_idname = __package__

    def get_device_types(self, context):
        from . import _steam
        has_opencl, has_vulkan, has_embree = _steam.get_device_types()
        list = [('NONE', "None", "Don't use compute device", 0)]
        if has_embree:
            list.append(('EMBREE', "Embree", "Use Embree for RadeonRays acceleration", 3))
        if has_vulkan:
            list.append(('VULKAN', "Vulkan", "Use Vulkan for RadeonRays acceleration", 2))
        if has_opencl:
            list.append(('OPENCL', "OpenCL", "Use OpenCL for RadeonRays acceleration", 1))
        return list

    compute_device_type: EnumProperty(
        name="Compute Device Type",
        description="Device to use for computation (rendering with Steam)",
        items=get_device_types,
    )

    devices: bpy.props.CollectionProperty(type=SteamDeviceSettings)
    ...
    def update_device_entries(self, device_list):
        for device in device_list:
            if not device[1] in {'EMBREE', 'VULKAN', 'OPENCL', 'ANY'}:
                continue
    ...
    def get_devices_for_type(self, compute_device_type):
        ...
        device_list = _steam.available_devices(compute_device_type)
        ...
        if compute_device_type in ('VULKAN', 'OPENCL', 'EMBREE'):
            devices.extend(cpu_devices)
        return devices

    def get_devices(self, compute_device_type=''):
        embree_devices = self.get_devices_for_type('EMBREE')
        vulkan_devices = self.get_devices_for_type('VULKAN')
        opencl_devices = self.get_devices_for_type('OPENCL')
        return embree_devices, vulkan_devices, opencl_devices

    def get_num_gpu_devices(self):
        from . import _steam
        device_list = _steam.available_devices(self.compute_device_type)
        num = 0
        for device in device_list:
    ...
    def _draw_devices(self, layout, device_type, devices):
        ...
        if not found_device:
            ...
            col.label(text="Steam will render on the CPU", icon='BLANK1')
            return
        ...
        if device_type == 'OPTIX':
            ...
            col.label(text="Not all Steam features are supported yet", icon='BLANK1')
    ...
    def draw_impl(self, layout, context):
        ...
        row = layout.row()
        if self.compute_device_type == 'EMBREE':
            self._draw_devices(row, 'EMBREE', devices)
        elif self.compute_device_type == 'VULKAN':
            self._draw_devices(row, 'VULKAN', devices)
...
class SteamView3DShadingSettings(bpy.types.PropertyGroup):
...
def register():
    bpy.utils.register_class(SteamRenderSettings)
    bpy.utils.register_class(SteamCameraSettings)
    bpy.utils.register_class(SteamMaterialSettings)
    bpy.utils.register_class(SteamLightSettings)
    bpy.utils.register_class(SteamWorldSettings)
    bpy.utils.register_class(SteamVisibilitySettings)
    bpy.utils.register_class(SteamMeshSettings)
    bpy.utils.register_class(SteamObjectSettings)
    bpy.utils.register_class(SteamCurveRenderSettings)
    bpy.utils.register_class(SteamDeviceSettings)
    bpy.utils.register_class(SteamPreferences)
    bpy.utils.register_class(SteamAOVPass)
    bpy.utils.register_class(SteamRenderLayerSettings)
    bpy.utils.register_class(SteamView3DShadingSettings)

    bpy.types.View3DShading.steam = bpy.props.PointerProperty(
        name="Steam Settings",
        type=SteamView3DShadingSettings,
    )


def unregister():
    bpy.utils.unregister_class(SteamRenderSettings)
    bpy.utils.unregister_class(SteamCameraSettings)
    bpy.utils.unregister_class(SteamMaterialSettings)
    bpy.utils.unregister_class(SteamLightSettings)
    bpy.utils.unregister_class(SteamWorldSettings)
    bpy.utils.unregister_class(SteamMeshSettings)
    bpy.utils.unregister_class(SteamObjectSettings)
    bpy.utils.unregister_class(SteamVisibilitySettings)
    bpy.utils.unregister_class(SteamCurveRenderSettings)
    bpy.utils.unregister_class(SteamDeviceSettings)
    bpy.utils.unregister_class(SteamPreferences)
    bpy.utils.unregister_class(SteamAOVPass)
    bpy.utils.unregister_class(SteamRenderLayerSettings)
    bpy.utils.unregister_class(SteamView3DShadingSettings)
