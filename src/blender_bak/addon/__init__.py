...
bl_info = {
    "name": "Steam Render Engine",
    "author": "",
    "blender": (2, 80, 0),
    "description": "Steam renderer integration",
    "warning": "",
    "doc_url": "",
    "tracker_url": "",
    "category": "Render"}
...
class SteamRender(bpy.types.RenderEngine):
    bl_idname = 'STEAM'
    bl_label = "Steam"
    ...
    def update(self, data, depsgraph):
        if not self.session:
            if self.is_preview:
                steam_scene = bpy.context.scene.steam
                use_osl = steam_scene.shading_system and steam_scene.device == 'CPU'
